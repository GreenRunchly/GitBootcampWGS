                        ...
                        if (req.files){
                            ...
                            if (filekonten.mimetype == `application/vnd.openxmlformats-officedocument.wordprocessingml.document`){
                                ...
                                mammoth.convertToHtml({buffer:filekonten.data}).then(function(result){
                                    ...
                                    `;
                                    let sqlsyninput = [modval.validator.escape(title), input_content, idrecord];
                            ...
                            `;
                            let sqlsyninput = [modval.validator.escape(title), idrecord];
                ...
                if (req.files){
                    ...
                    if (filekonten.mimetype == `application/vnd.openxmlformats-officedocument.wordprocessingml.document`){
                        ...
                        mammoth.convertToHtml({buffer:filekonten.data}).then(function(result){
                            ...
                            VALUES ( ?, ?, ?, ? )
                            `;
                            pooldb.query( sqlsyn, [akun.id, idkelas, modval.validator.escape(title), input_content], (err, result) => { 
